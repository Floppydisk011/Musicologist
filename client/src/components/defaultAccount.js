...
const DefaultAccount = () => {
    return (
        <div className='defaultPage'>
            <p>
                In the Musicologist e-commerce platform, users can manage their account details seamlessly.<br />
                ...
                <br /><br />
                For any problems or questions please feel free to contact us at: "musicologist.business@gmail.com".<br />
            </p>
        </div>
    );
}
